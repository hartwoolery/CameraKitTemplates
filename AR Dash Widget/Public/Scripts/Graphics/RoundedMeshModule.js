...
var Builder = function(parent, widgetOptions) {
    this.numSides = 40;
    this.width = 1;
    this.height = 1;
    
    //avoid z-fighting
    this.depth = widgetOptions.depth + widgetOptions.index * 0.1; 

    this.borderRadius = widgetOptions.borderRadius;
    this.borderSize = widgetOptions.borderSize;
    this.borderColor = widgetOptions.borderColor;
    this.useEnvironmentLighting = widgetOptions.useEnvironmentLighting;
    this.renderToMesh = parent.getChild(0).getComponent("Component.RenderMeshVisual")
    this.renderToMesh.setRenderOrder(1)
    this.renderToMesh.mainMaterial = widgetOptions.material
    this.mainPass = widgetOptions.material.mainPass;
